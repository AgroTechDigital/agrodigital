...
/**
 * Api services for the `FinanceiroMovimentacao` model.
 */
@Injectable()
export class FinanceiroMovimentacaoApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id financeiroMovimentacao id
   *
  ...
  public getCategoria(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    "/financeiroMovimentacaos/:id/categoria";
