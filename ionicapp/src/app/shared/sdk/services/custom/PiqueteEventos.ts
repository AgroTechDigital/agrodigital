...
/**
 * Api services for the `PiqueteEventos` model.
 */
@Injectable()
export class PiqueteEventosApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id piqueteEventos id
   *
  ...
  /**
   * Statistical information for piqueteEventos registers.
   *
